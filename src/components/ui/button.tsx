  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full font-semibold cursor-pointer transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-foreground/25 bg-background text-foreground hover:bg-muted",
        secondary: "bg-muted text-foreground hover:bg-secondary",
        ghost: "hover:bg-muted",
        link: "text-primary underline underline-offset-4",
        hero: "bg-background text-primary hover:bg-muted",
        dark: "bg-foreground text-background hover:bg-brand-deep",
        spark: "bg-warm text-warm-foreground hover:brightness-95",
      },
      size: {
